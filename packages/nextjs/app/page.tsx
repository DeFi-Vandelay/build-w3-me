      ...
      <div className="flex items-left flex-col flex-grow pt-10">
        <div className="px-5">
          <h1 className="text-center">
            <span className="block text-2xl font-bold text-primary">Art3 </span>
            <span className="block text-2xl font-bold text-primary">Build-w-me // Ether Stack </span>
          </h1>
        ...
        <div className="flex-grow bg-base-200 w-full mt-16 px-8 py-12">
          <div className="flex justify-center items-center gap-12 flex-col sm:flex-row">
            <div className="flex flex-col bg-base-100 px-10 py-10 text-center items-center max-w-xs rounded-3xl shadow-center">
